...
class Event(Base):
    ...
    source_type = Column(ENUM('FACEBOOK', 'FACEBOOK_BULK', 'EVENTBRITE', 'EVENTBRITE_BULK', 'INSTAGRAM', 'WEBPAGE', 'ICS', 'RSS', 'MANUAL', 'facebook_bulk', 'eventbrite', 'eventbrite_bulk', 'DALLAS_ARBORETUM', 'dallas_arboretum', 'KLYDE_WARREN_PARK', name='sourcetype', create_type=True), nullable=False)
